<?php
  ...
  $mainContentClass = (fastwp_sidebar_position() != '' && ("blogPost2" == fastwp_blog_type() || "blogPost3" == fastwp_blog_type()) )? 'col-md-9 col-xs-12 blpadding':'col-md-12';
?>
<section id="blogContent">
	<div class="container container-blog pBottom-110">
		<div class="row">
